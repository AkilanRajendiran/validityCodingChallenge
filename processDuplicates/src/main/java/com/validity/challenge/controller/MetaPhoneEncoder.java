...
import org.apache.commons.codec.StringEncoder;
 ...
 public class MetaPhoneEncoder implements StringEncoder {
    ...
    public static void main(String[] args) {
        ...
        String s1 = "bparncutta@ezinearticles.com";
        String s2 = "bpcrncutta";

        /* Check if
         1.  the firstname + LastName is equal
         2.  Email iD is equal
         3.  Phone number is equal
         4.  Address1 + Address2 + City + State + Zipcode
         5.  Company is equal
         */

        MetaPhoneEncoder m = new MetaPhoneEncoder();

        boolean flag = m.isMetaphoneEqual(s1,s2);
        m.getMaxCodeLen();
        System.out.println("m.getMaxCodeLen()==" +m.getMaxCodeLen());
        //System.out.println("m.maxCodeLen()=="+m.encode());
